...
// TMB LCT Match
  ...
  input              hmt_readout_tmb_ff;//hmt readout 
  input              tmb_pulse_hmt_only; // tmb pulse is from HMT
  input              tmb_keep_hmt_only; // tmb keep is from HMT
...
// Counter enable strobes
  always @(posedge clock) begin
    ...
    gem_cnt_en[0]  <= gemA_sync_err;
    gem_cnt_en[1]  <= gemB_sync_err;
    gem_cnt_en[2]  <= gems_sync_err;
