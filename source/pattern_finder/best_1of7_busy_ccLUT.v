...
// Choose bits to sort on, either sortable pattern or post-fit quality
  ...
  wire [MXPATB -1:0] sort_key0 = pat0[MXPATB -1:1];
  wire [MXPATB -1:0] sort_key1 = pat1[MXPATB -1:1];
  wire [MXPATB -1:0] sort_key2 = pat2[MXPATB -1:1];
  wire [MXPATB -1:0] sort_key3 = pat3[MXPATB -1:1];
  wire [MXPATB -1:0] sort_key4 = pat4[MXPATB -1:1];
  wire [MXPATB -1:0] sort_key5 = pat5[MXPATB -1:1];
  wire [MXPATB -1:0] sort_key6 = pat6[MXPATB -1:1];
