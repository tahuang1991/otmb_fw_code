...
// Firmware version global definitions
  ...
  `define MONTHDAY             16'h0131 // Version date
...
//`define FPGAID               16'h6195 // FPGA Type 6195 XC6VLX195T
  ...
  `define VERSION_FORMAT       04'h3   // [12:9]; 0=TMB standard, 1=OTMB Standard, 2=CCLUT, 3=GEM+CCLUT
  `define VERSION_MAJOR        04'h0   // [08:05];4 bits = Major Version (major features which breaks compatibility, requires changes to other board firmware) 
  `define VERSION_MINOR        05'h0   // [04:00];5 bits = Minor version  (minor features, internal fixes, bug fixes, etc). 
...
//  12/17/2013  JRG: tuning link monitor logic & use "testLED" testpoints for diagnostic signals
