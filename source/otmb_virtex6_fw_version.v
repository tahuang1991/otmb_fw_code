...
// Firmware version global definitions
  ...
  `define MONTHDAY             16'h1108 // Version date
  `define YEAR                 16'h2022 // Version year
...
//`define FPGAID               16'h6195 // FPGA Type 6195 XC6VLX195T
  ...
  `define VERSION_FORMAT       04'h3   // [12:09]; 0=TMB standard, 1=OTMB Standard, 2=CCLUT, 3=GEM+CCLUT
  ...
  `define VERSION_MINOR        05'h3   // [04:00];6 bits = Minor version  (minor features, internal fixes, bug fixes, etc). 
  //minor version code:
