...
// Firmware version global definitions
  ...
  `define MONTHDAY      16'h0628 // Version date
  `define YEAR          16'h2019 // Version year
...
// Conditional compile flags: Enable only one CSC_TYPE
 ...
 // `define CSC_TYPE_D  04'hC    // Reversed ME1B: ME1B   chambers facing away from IR. ME1B hs = reversed, ME1A hs =!reversed
